...
public class PostingAgent extends WorkflowEngineAgent {
	...
	protected void agentSpecificSetup() throws AgentInitializationException {
		...
		sd.setType("posting");
		sd.setName("JADE-investalia-posting");
		dfd.addServices(sd);
		try {
		...
		WorkflowDescriptor wd = new WorkflowDescriptor("gsi.investalia.server.wade.PostingWorkflow");
		try {
	...
	protected void takeDown() {
		...
		System.out.println("Posting-agent " + getAID().getName() + " terminating.");
	}
