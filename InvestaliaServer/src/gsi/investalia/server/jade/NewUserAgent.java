...
public class NewUserAgent extends WorkflowEngineAgent {
	...
	protected void agentSpecificSetup() throws AgentInitializationException {
		...
		sd.setType("newuser");
		sd.setName("JADE-investalia-newuser");
		dfd.addServices(sd);
		try {
		...
		WorkflowDescriptor wd = new WorkflowDescriptor("gsi.investalia.server.wade.NewUserWorkflow");
		try {
	...
	protected void takeDown() {
		...
		System.out.println("New User-agent " + getAID().getName() + " terminating.");
	}
